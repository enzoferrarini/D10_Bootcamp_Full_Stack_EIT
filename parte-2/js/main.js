function agregarLibro(idDestino,htmlString){
    let sectionHtml=document.getElementById(idDestino);
    sectionHtml.innerHTML=sectionHtml.innerHTML.concat(htmlString);
}
...
//Descomentar en caso de querer ver que siguen funcionando los
...
//Punto 13 - en vez de usar el siguiente codigo:
...
//se creo la función agregarLibro para ello.
//de todas formas si descomentamos el codigo del enunciado
//funciona tambien sin utilziar la func agregarLibro();

agregarLibro("libros",libro1.getHtmlArticle());
agregarLibro("libros",libro2.getHtmlArticle());
agregarLibro("libros",libro3.getHtmlArticle());
agregarLibro("libros",libro4.getHtmlArticle());
agregarLibro("libros",libro5.getHtmlArticle());


//Parte 3 - Punto 16
//Para que solo agregue 4 libros segun el codigo del enunciado
//comentar Punto 13 llamados a la funcion agregarLibro() del punto anterior.
//Caso contrario quedaran 9 libros. 
...
//Idem anterior. Comentar Punto 16 y 13
